...
public abstract class AbstractShape
{
    ...
    /**
     * Check the clicked point is in the shape bounding box
     * @param  x the x cordinated clicked point
     * @param y the y cordinated clicked point
     * @return arraylist of clicked shape
    */
    public static ArrayList<AbstractShape> checkInShape(int x,int y)
    {
        ArrayList<AbstractShape> shapeIn = new ArrayList<AbstractShape>();  // arraylist of clicked shape
        /* loop for find the shapes are clicked */
        for(int i=0; i< allFigures.size();i++)
        {
            AbstractShape shape = allFigures.get(i);    
